...
function Topbar({ startTime, duration, onFinish, onFinishMutation }: { startTime: string, duration: number, onFinish: () => void, onFinishMutation: any }) {
    ...
    return (
        <header className="flex h-16 shrink-0 justify-between items-center gap-2 border-b px-4">
            ...
            <div className='text-destructive'>
                {isFullyLoaded && <Countdown startTime={new Date(startTime)} duration={duration * 60} onEnd={onFinish} />}
            </div>
