...
function QuestionCard() {
  ...
  useEffect(() => {
    if (selectedOptions != null) {
      let prev_user_answers_str: string | null =
  ...
  function incrementCounter() {
    dispatch(setQuestionCounter(questionCounter ? questionCounter + 1 : 0));
  }
    ...
    <Card className="card__question" data-question-id={question?.id}>
      ...
      <CardFooter>
        <div className="w-full flex items-center justify-between">
          <Button
            disabled={!(questionCounter != null && questionCounter > 1)}
            variant="outline"
          ...
          <Button
            disabled={
              !(questionCounter != null && questionCounter < totalQuestions)
            }
