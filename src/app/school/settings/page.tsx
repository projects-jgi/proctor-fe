...
export default function SchoolSettingsPage() {
  ...
  return (
    <SchoolLayout title="Settings" subtitle="Customize your school preferences and system settings">
          ...
          <TabsContent value="general" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure your school's general preferences and policies
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="notifications" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose how you want to be notified about school-wide activities
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get reminded about upcoming school-wide exams
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notifications when school exam results are ready
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>Department Messages</Label>
                      <p className="text-sm text-muted-foreground">
                        Notifications for department inquiries and messages
                      </p>
                    </div>
                    <Switch
          ...
          <TabsContent value="privacy" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Control your school's privacy and data sharing preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="private">Private - Visible only to administrators</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>Allow Department Messages</Label>
                      <p className="text-sm text-muted-foreground">
                        Allow department heads to send you direct messages
                      </p>
                    </div>
                    <Switch
                      checked={settings.allowDepartmentMessages}
                      onCheckedChange={(checked) => setSettings({...settings, allowDepartmentMessages: checked})}
                    />
                  </div>
                </div>
          ...
          <TabsContent value="security" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your school account security and authentication preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Change Password */}
          ...
          <TabsContent value="appearance" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Customize the look and feel of your school interface
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
