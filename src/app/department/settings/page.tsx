...
export default function DepartmentSettingsPage() {
  ...
  return (
    <DepartmentLayout title="Settings" subtitle="Customize your department preferences and system settings">
          ...
          <TabsContent value="general" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure your department's general preferences
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="notifications" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose how you want to be notified about department activities
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get reminded about upcoming department exams
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notifications when department exam results are ready
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notifications for faculty inquiries and messages
                      </p>
                    </div>
                    <Switch
          ...
          <TabsContent value="privacy" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Control your department's privacy and data sharing preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'public' | 'school' | 'private') =>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="school">School - Visible to school members</SelectItem>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>Allow Faculty Messages</Label>
                      <p className="text-sm text-muted-foreground">
                        Allow faculty members to send you direct messages
                      </p>
                    </div>
                    <Switch
                      checked={settings.allowFacultyMessages}
                      onCheckedChange={(checked) => setSettings({...settings, allowFacultyMessages: checked})}
                    />
                  </div>
                </div>
          ...
          <TabsContent value="security" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your department account security and authentication preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Change Password */}
          ...
          <TabsContent value="appearance" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Customize the look and feel of your department interface
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
