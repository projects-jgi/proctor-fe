...
import { get_student_attempt_answers, get_student_attempt_result } from '@/lib/server_api/student'
...
async function page({ params }: {params: PageParams}) {
    ...
    const result_answers = await get_student_attempt_answers({ exam_id: parseInt(exam_id) });
